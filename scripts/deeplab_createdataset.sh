...
DATASET_NAME="scooter_base"
PATH_TO_DEEPLAB_DATASET="D:/data"
...
#SCOOTER PATHS, max 4251, 603
SCOOTER_IMAGE_PATH="D:/data/scooter_labelled/scooter_images"
SCOOTER_SEG_PATH="D:/data/scooter_labelled/scooter_seg"
