...
#     --train_logdir="${PATH_TO_DATASET}/control" \
...
--checkpoint_dir="${PATH_TO_DATASET}/control" \
--event_dir="${PATH_TO_DATASET}/control_eval" &
...
python /home/whizz/Desktop/deeplabv3/deeplab/eval.py \
    ...
    --dataset=${DATASET_NAME} \
    --checkpoint_dir="${PATH_TO_DATASET}/control" \
    --eval_logdir="${PATH_TO_DATASET}/control_eval" \
    --dataset_dir=${PATH_TO_TFRECORDS}
